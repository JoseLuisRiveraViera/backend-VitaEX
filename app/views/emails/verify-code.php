...
<head>
    ...
    <title>Código de Verificación - VitaeX</title>
</head>
    ...
    <tr>
        <td align="center">
            ...
            <table width="580" cellpadding="0" cellspacing="0"
                ...
                <!-- Franja superior -->
                <tr>
                    <td style="background-color:#03837b; height:6px; font-size:0;">&nbsp;</td>
                </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="vertical-align:middle;">
                                    <div style="display:inline-block; background-color:#03837b; border-radius:8px;
                ...
                <tr>
                    <td style="padding: 35px 48px 20px 48px;">
                        ...
                        <p style="margin:0; font-size:15px; color:#4b5563; line-height:1.6;">
                            Has solicitado ingresar a la plataforma <strong>VitaeX</strong>. 
                            Por seguridad, ingresa el siguiente código para confirmar que eres tú.
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 25px 48px 40px 48px;">
                        <div style="background-color:#f9fafb; border-radius:12px; padding: 35px 24px;
                           text-align:center; border: 1px solid #f3f4f6;">
                            <p style="margin:0 0 12px 0; font-size:12px; font-weight:700; color:#9ca3af;
                            text-transform:uppercase; letter-spacing:3px;">
                                CÓDIGO DE SEGURIDAD
                            </p>
                            <p style="margin:0; font-size:48px; font-weight:900; color:#03837b;
